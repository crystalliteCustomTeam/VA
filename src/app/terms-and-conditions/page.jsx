...
export default function TermsCO() {
  return (
    <>
          ...
          <Row>
            <Col>
              ...
              <p>
                ...
                divulged to any third party, other than our team if legally
                required to do so to the appropriate authorities. Clients have
                the right to request sight of, and copies of any and all Client
                Records we keep, on the proviso that we are given reasonable
                notice of such a request. Clients are requested to retain copies
                of any literature issued in relation to the provision of our
                services. Where appropriate, we shall issue Client’s with
                appropriate written information, handouts or copies of records
                as part of an agreed contract, for the benefit of both parties.
              </p>
              <p>
              ...
              <p>
                ...
                incidental damages. This Company does not however exclude
                ...
                permitted by law. None of your statutory rights as a consumer
                are affected.
              </p>
              <h3>Payment</h3>
              <p>
                Payments can be made via Checks, all major Credit/Debit Cards
                and Bank Transfers. Payment terms are decided & agreed at the
                time of sales agreement. All goods remain the property of the
              ...
              <p>
                ...
                Services Agreement for any reason, including the ending of
                services that are already underway.
              </p>
              <p>
                If approved, all purchases above $15,000 will be refunded in
                equal monthly installments of $5000.
              </p>
              <p>
                No refunds shall be offered, where a Service is deemed to have
                begun and is, for all intents and purposes, underway. Any monies
                that have been paid to us which constitute payment in respect of
                the provision of unused Services, shall be refunded.
              </p>
              <h3>Communication Policy</h3>
              <p>
                YOU agree that Video Animation LLC is not liable for any
                correspondence from email address(es) other than the ones
                followed by our own domain i.e.
                &apos;..@videoanimationllc.com&apos; or/and any toll free number
                that is not mentioned on our website. Video Animation LLC should
                not be held responsible for any damage(s) caused by such
                correspondence. We only take responsibility of any communication
                through email address(es) under our own domain name or/and via
                toll free number i.e. already mentioned on Video Animation LLC
                Website.
              </p>
              <p>
                Notice of cancellation required via email, Call and/or fax, or
                any other means will be accepted subject to confirmation in
                writing.
              </p>
              <h3>Cookies</h3>
              <p>
              ...
              <h3>Communication</h3>
              <p>
                We have several e-mail addresses for different queries. These, &
              ...
              <h3>General</h3>
              <p>
                The laws of the United States of America govern these terms and
                ...
                jurisdiction of the courts in the USA for all disputes arising
                ...
                remaining terms will continue to apply. Failure of the Company
                to enforce any of the provisions set out in these Terms and
                Conditions and any Agreement, or failure to exercise any option
                to terminate, shall not be construed as waiver of such
                provisions and shall not affect the validity of these Terms and
                Conditions or any Agreement or any part thereof, or the right
                thereafter to enforce each and every provision. These Terms and
                Conditions shall not be amended, modified, varied or
                supplemented except in writing and signed by duly authorised
              ...
              <p>
                ...
                notification by email or postal mail will be made to those
              ...
              <p>
                ...
                an event shall forthwith inform the other Party of the same and
              ...
              <p>
                ...
                provision of this or any Agreement or the failure of either
                Party to exercise any right or remedy to which it, he or they
                are entitled hereunder shall not constitute a waiver thereof and
