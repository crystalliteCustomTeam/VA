  ...
  return (
    <>
      <Head>
        <link
          rel="preload"
          href="https://player.vimeo.com/progressive_redirect/playback/1025562046/rendition/540p/file.mp4?loc=external&signature=2b1f66327223317b633d13487ab29b223334cb06b19e65fcc8b6b7a1522f6fe7"
          as="video"
          type="video/mp4"
        />
      </Head>
            ...
            <Col md={12}>
              <div className={styles.footerMenuSec}>
                <div className={`${styles.menuItem} ${styles.FooterLogo}`}>
                  ...
                  >
                    <source
                      src="https://player.vimeo.com/progressive_redirect/playback/1025562046/rendition/540p/file.mp4?loc=external&signature=2b1f66327223317b633d13487ab29b223334cb06b19e65fcc8b6b7a1522f6fe7"
                      type="video/mp4"
                    />
                ...
                <div className={styles.menuItem}>
                  <div
                    className={`${styles.footerContent} ${styles.mainlinks}`}
                  >
                    <h6>Contact Info</h6>
                    ...
                    <div className={styles.contactInfo}>
                      <a
                        href="mailto:queries@videoanimation.us"
                        target="_blank"
                      >
                        <FooterEmail />
