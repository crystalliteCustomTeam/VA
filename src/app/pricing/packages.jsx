        ...
        <div className={styles.pricing}>
          <div className={styles.pricingBox}>
            <div className={styles.box}>
              <h4 className="textGradient">
                Silver<span> Packages</span>
              </h4>
              <p>
                We have something in store for everyone, and that something is
                affordable services
              </p>
            ...
            <ul className={styles.pricingList}>
              <li>
                <PackageTick /> 30 Seconds Duration
              </li>
              <li>
                <PackageTick /> Script Writing
              </li>
              <li>
                <PackageTick /> Custom Artwork
              </li>
              <li>
                <PackageTick /> Background Music
              </li>
              <li>
                <PackageTick /> HD Format Video
              </li>
              <li>
                <PackageTick /> Dedicated Support
              </li>
            </ul>
          </div>
          ...
          <div className={styles.pricingBox}>
            ...
            <ul className={styles.pricingList}>
              ...
              <li>
                <PackageTick /> Professional Voice-over & SFX
              </li>
              <li>
                <PackageTick /> Hand-drawn Illustrations
              </li>
              <li>
                <PackageTick /> Unlimited Revisions
              </li>
              <li>
                <PackageTick /> HD Format Video
              </li>
          ...
          <div className={styles.pricingBox}>
            ...
            <ul className={styles.pricingList}>
              ...
              <li>
                <PackageTick /> Custom 2D Character Illustration
              </li>
              <li>
                <PackageTick /> Unlimited Revisions
              </li>
