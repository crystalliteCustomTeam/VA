import {
  ...
  ImageCtaContent,
  FaqList,
} from "@/src/app/motion-graphics/data/data"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebSite",
            name: "Motion Graphics Services - Video Animation Company USA",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Corporation",
            name: "Motion Graphics Services - Video Animation Company USA",
            alternateName: "Motion Graphics Video Animation Studio",
            url: "https://videoanimation.us/motion-graphics",
            logo: "",
            sameAs: [
              ...
              "https://videoanimation.us/motion-graphics",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org/",
            "@type": "Product",
            name: "Motion Graphics Services - Video Animation",
            image: "https://videoanimation.us/motion-graphics",
            description:
