import {
  ...
  ImageCtaContent,
  FaqList,
} from "@/src/app/cel-animation/data/data"
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebSite",
            name: "Cel Animation Services - Video Animation Company USA",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Corporation",
            name: "Cel Animation Services - Video Animation Company USA",
            alternateName: "Cel Video Animation Studio",
            url: "https://videoanimation.us/cel-animation",
            logo: "",
            sameAs: [
              ...
              "https://videoanimation.us/cel-animation",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org/",
            "@type": "Product",
            name: "Cel Animation Services - Video Animation",
            image: "https://videoanimation.us/cel-animation",
            description:
