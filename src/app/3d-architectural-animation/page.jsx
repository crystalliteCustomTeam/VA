import {
  ...
  ImageCtaContent,
  FaqList,
} from "@/src/app/3d-architectural-animation/data/data"
import {
  slides,
  options,
  ClientsReview,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Corporation",
            name: "3D Animation Services - Video Animation Company USA",
            alternateName: "3D Architectural Video Animation Studio",
            url: "https://videoanimation.us/3d-architectural-animation",
            logo: "",
            sameAs: [
              ...
              "https://videoanimation.us/3d-architectural-animation",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org/",
            "@type": "Product",
            name: "3D Architectural Animation Services - Video Animation",
            image: "https://videoanimation.us/3d-architectural-animation",
            description:
              "Elevate your projects with realistic 3D Architectural Animation Services. Our architectural visualization animations create detailed renderings for impactful presentations. Transform ideas into captivating visual experiences. Discover innovation in motion.",
            brand: {
              "@type": "Brand",
