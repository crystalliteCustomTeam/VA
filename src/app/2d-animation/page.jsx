import {
  ...
  ImageCtaContent,
  FaqList,
} from "@/src/app/2d-animation/data/data"
import {
  slides,
  options,
  ClientsReview,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebSite",
            name: "2D Animation Services - Video Animation Company USA",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Corporation",
            name: "2D Animation Services - Video Animation Company USA",
            alternateName: "2D Video Animation Studio",
            url: "https://videoanimation.us/2d-animation",
            logo: "",
            sameAs: [
              ...
              "https://videoanimation.us/2d-animation",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org/",
            "@type": "Product",
            name: "2D Animation Services - Video Animation",
            image: "",
            description:
              "Video Animation Studio is your one-stop shop for professional 2D animation services. Our expert 2D animators craft engaging, fluid animations with expressive characters and vibrant visuals, perfect for your brand or project.",
            brand: {
              "@type": "Brand",
