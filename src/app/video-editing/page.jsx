import {
  ...
  ImageCtaContent,
  FaqList,
} from "@/src/app/video-editing/data/data"
import {
  slides,
  options,
  ClientsReview,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebSite",
            name: "Video Editing Animation Services - Video Animation Company USA",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Corporation",
            name: "Video Editing Animation Services - Video Animation Company USA",
            alternateName: "Video Editing Animation Studio",
            url: "https://videoanimation.us/video-editing",
            logo: "",
            sameAs: [
              ...
              "https://videoanimation.us/video-editing",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org/",
            "@type": "Product",
            name: "Video Editing Animation Services - Video Animation",
            image: "https://videoanimation.us/video-editing",
            description:
