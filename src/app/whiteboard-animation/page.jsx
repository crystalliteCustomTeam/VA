import {
  ...
  ImageCtaContent,
  FaqList,
} from "@/src/app/whiteboard-animation/data/data"
import {
  slides,
  options,
  ClientsReview,
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebSite",
            name: "Whiteboard Animation Services - Video Animation Company USA",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "Corporation",
            name: "Whiteboard Animation Services - Video Animation Company USA",
            alternateName: "Whiteboard Video Animation Studio",
            url: "https://videoanimation.us/whiteboard-animation",
            logo: "",
            sameAs: [
              ...
              "https://videoanimation.us/whiteboard-animation",
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org/",
            "@type": "Product",
            name: "Whiteboard Animation Services - Video Animation",
            image: "https://videoanimation.us/whiteboard-animation",
            description:
